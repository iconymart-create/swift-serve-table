  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-glow transition-smooth",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90 transition-smooth",
        pending: "bg-pending text-pending-foreground hover:bg-pending/90 transition-smooth",
        restaurant: "bg-gradient-restaurant text-primary-foreground hover:shadow-glow transition-bounce",
      },
      size: {
